...
$lang['new_solver'] = '📢 {user} solved challenge [{challenge_title}](<'.Config::get('MELLIVORA_CONFIG_SITE_URL').'challenge?id={challenge_id}>). Congratulations!';
$lang['new_submission'] = '{user} sent {num_attempts}. attempt to solve challenge {challenge_title}. {result} {flag}.';
$lang['new_registration'] = 'New registration: {user}, {email}, {ip}';
$lang['activity'] = 'Activity: {user}, {full_name}, {email}, {ip}';