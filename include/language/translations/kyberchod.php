...
$lang['new_solver'] = '📢 {user} má vyřešenou úlohu [{challenge_title}](<'.Config::get('MELLIVORA_CONFIG_SITE_URL').'challenge?id={challenge_id}>), gratulujeme!';
$lang['new_submission'] = '{user} posílá {num_attempts}. řešení úlohy {challenge_title}. {result} {flag}.';
$lang['new_registration'] = 'Nová registrace: {user}, {email}, {ip}';
$lang['activity'] = 'Aktivita: {user}, {full_name}, {email}, {ip}';