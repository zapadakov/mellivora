...
//Discord
Config::set('MELLIVORA_CONFIG_DISCORD_BOT_TOKEN', '');
Config::set('MELLIVORA_CONFIG_DISCORD_GUILD_ID', 0);
Config::set('MELLIVORA_CONFIG_DISCORD_BOT_ID', 0);
Config::set('MELLIVORA_CONFIG_DISCORD_NON_COMPETITOR_ROLE_ID', 0);
Config::set('MELLIVORA_CONFIG_DISCORD_COMPETITOR_ROLE_ID', 0);
Config::set('MELLIVORA_CONFIG_DISCORD_WEBHOOK_GENERAL_ID', 0);
Config::set('MELLIVORA_CONFIG_DISCORD_WEBHOOK_GENERAL_TOKEN', '');
Config::set('MELLIVORA_CONFIG_DISCORD_WEBHOOK_SUBMISSIONS_ID', 0);
Config::set('MELLIVORA_CONFIG_DISCORD_WEBHOOK_SUBMISSIONS_TOKEN', '');